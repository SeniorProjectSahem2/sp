...
class PricingsControllerTest < ActionController::TestCase
  ...
  test "should create pricing" do
    assert_difference('Pricing.count') do
      post :create, pricing: { daily: @pricing.daily, item_id: @pricing.item_id, monthly: @pricing.monthly, yearly: @pricing.yearly }
    end
  ...
  test "should update pricing" do
    patch :update, id: @pricing, pricing: { daily: @pricing.daily, item_id: @pricing.item_id, monthly: @pricing.monthly, yearly: @pricing.yearly }
    assert_redirected_to pricing_path(assigns(:pricing))
  end
